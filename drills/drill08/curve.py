...
def draw_curve_4_point_round(p1,p2,p3,p4):
    draw_big_point(p1)
    draw_big_point(p2)
    draw_big_point(p3)
    draw_big_point(p4)
...
#draw_curve_3_points((-50,150),(150,-100),(350,300))
#draw_curve_4_points((-350,-100),(-50,200),(150,-100),(350,300))
draw_curve_4_point_round((-300,100),(400,350),(350,-200),(-250,-150))
turtle.done()