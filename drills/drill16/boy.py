...
def collid(boy):
    if boy.y_velocity > boy.fence_height:
        return True
    elif boy.y_velocity < boy.fence_bottom:
        return True
    return False
...
class Boy:
    ...
    def __init__(self):
        ...
        self.fence_height = 350
        self.fence_bottom = -350
        self.fence_left_bottom_x = 20
        self.fence_right_bottom_x = 580
        self.fence_left_top_x = 200
        self.fence_right_top_x = 600
    ...
    def draw(self):
        ...
        self.font.draw(self.canvas_width//2 - 60, self.canvas_height//2 + 50, '     %d' % self.count, (255, 255, 0))
