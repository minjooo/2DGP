...
def enter():
    global main_bg, character, path, number, following_marbles, is_crush, map
...
def exit():
    global main_bg, character, path, number, Cards_up, Boyfriends_up, Brooms_up, Marbles_up,Cards_down, Boyfriends_down, Brooms_down, Marbles_down, Tray_up, Tray_down, up, down,following_marbles,  is_crush
    del main_bg
    del character
    del path
    del number
