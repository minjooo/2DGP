...
class RunUpState:
    ...
    @staticmethod
    def do(sad):
        sad.frame = (sad.frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time) % FRAMES_PER_ACTION

    @staticmethod
    def draw(sad):
        sad.image.clip_draw(int(sad.frame) * 100, 0, 100, 100, 200, 360)
...
class RunDownState:
    ...
    @staticmethod
    def draw(sad):
        sad.image.clip_composite_draw(int(sad.frame) * 100, 0, 100, 100, 0, 'v', 200, 240, 100, 100)
